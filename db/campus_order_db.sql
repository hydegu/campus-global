...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '外卖订单扩展表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `order_delivery` VALUES (10, 106, 1001, 2001, 69.00, 0.00, NULL, '2026-02-28 17:50:00', '2026-02-28 17:50:00');
INSERT INTO `order_delivery` VALUES (11, 107, 1001, 2001, 69.00, 0.00, NULL, '2026-02-28 18:00:42', '2026-02-28 18:00:42');
...
CREATE TABLE `order_main`  (
  ...
  `order_status` tinyint NOT NULL DEFAULT 1 COMMENT '订单状态:1-待接单 2-待取货 3-配送中 4-已送达 5-已取消 6-已完成 7-售后中',
...
) ENGINE = InnoDB AUTO_INCREMENT = 108 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单主表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `order_main` VALUES (106, '20260228175000DE80D866', 1, 1001, NULL, NULL, 69.00, 69.00, 0, NULL, NULL, NULL, 1, NULL, NULL, 1, 1001, NULL, NULL, NULL, 13.80, 3.45, 51.75, 0, '不要辣，多放葱', NULL, NULL, NULL, NULL, '2026-02-28 17:50:00', '2026-02-28 17:50:00', NULL);
INSERT INTO `order_main` VALUES (107, '202602281800414EA9D85D', 1, 1001, NULL, NULL, 69.00, 69.00, 0, NULL, NULL, NULL, 1, NULL, NULL, 1, 1001, NULL, NULL, NULL, 13.80, 3.45, 51.75, 0, '不要辣，多放葱', NULL, NULL, NULL, NULL, '2026-02-28 18:00:42', '2026-02-28 18:00:42', NULL);
...
CREATE TABLE `order_operation_log`  (
  ...
  `order_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单编号',
  `operation_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '操作类型:CREATE-创建,ACCEPT-接单,PICKUP-取货,DELIVER-送达,CONFIRM-确认,CANCEL-取消,PAY-支付',
  ...
  `operator_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '操作人名称',
  `operator_type` tinyint NULL DEFAULT NULL COMMENT '操作人类型:1-用户 2-骑手 3-商家 4-系统',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE,
  INDEX `idx_create_at`(`create_at` DESC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单操作审计日志表' ROW_FORMAT = DYNAMIC;
