-- 创建数据库
CREATE DATABASE IF NOT EXISTS `campus_service_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `commission_config`  (
  ...
  `commission_rate` decimal(10, 0) NOT NULL COMMENT '分佣比例，10代表10%',
