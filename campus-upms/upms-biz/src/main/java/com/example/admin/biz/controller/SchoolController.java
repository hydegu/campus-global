...
public class SchoolController {
    ...
    @HasPermission("system:school:add")
    ...
    @HasPermission("system:school:edit")
    ...
    @HasPermission("system:school:delete")
    ...
    @HasPermission("system:school:query")
    ...
    @HasPermission("system:school:list")
