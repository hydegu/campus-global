...
@RestController
@RequestMapping("/admin/rider/apply")
...
public class RiderApplyController {
	...
	@PreAuthorize("hasAuthority('admin:rider-apply:list')")
	...
	@PreAuthorize("hasAuthority('admin:rider-apply:approve')")
	...
	@PreAuthorize("hasAuthority('admin:rider-apply:reject')")
