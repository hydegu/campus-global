...
public class StaffAuditController {
	...
	@PreAuthorize("hasAuthority('audit:staff:list')")
	public Result<Page<ServiceStaffAuditVO>> listServiceStaffAudit(@Valid ServiceStaffAuditQueryDTO queryDTO) {
	...
	@PreAuthorize("hasAuthority('audit:staff:approve')")
	...
	@PreAuthorize("hasAuthority('audit:staff:reject')")
