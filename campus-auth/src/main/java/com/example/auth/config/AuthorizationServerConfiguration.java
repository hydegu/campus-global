...
import com.example.auth.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
...
import com.example.auth.support.handler.AuthenticationSuccessEventHandler;
import com.example.common.core.constant.SecurityConstants;
import com.example.common.security.component.CorsProperties;
...
public class AuthorizationServerConfiguration {
	...
	private void addCustomOAuth2GrantAuthenticationProvider(HttpSecurity http) {
		...
		OAuth2TokenGenerator<? extends org.springframework.security.oauth2.core.OAuth2Token> tokenGenerator = http.getSharedObject(OAuth2TokenGenerator.class);
