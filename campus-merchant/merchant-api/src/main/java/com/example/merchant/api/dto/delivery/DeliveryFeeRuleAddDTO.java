 ...
 */
@Data
@Schema(name = "DeliveryFeeRuleAddDTO", description = "新增配送费规则请求DTO")
public class DeliveryFeeRuleAddDTO {

	@Schema(description = "关联配置ID", requiredMode = Schema.RequiredMode.REQUIRED)
	@NotNull(message = "关联配置ID不能为空")
	private Long configId;

	@Schema(description = "规则类型：1-距离，2-时间", requiredMode = Schema.RequiredMode.REQUIRED)
