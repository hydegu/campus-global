...
public class ErrandCategoryAddDTO {
    ...
    @Schema(description = "分类层级：1-一级分类，2-二级分类", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "分类层级不能为空")
    private Integer level;

    @Schema(description = "分类名称", example = "跑腿代购", requiredMode = Schema.RequiredMode.REQUIRED)
