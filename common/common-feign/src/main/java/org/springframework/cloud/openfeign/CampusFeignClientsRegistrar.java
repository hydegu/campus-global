 ...
 */
public class CampusFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	...
	private String getName(Map<String, Object> attributes) {
		...
		name = resolve(name);
		return org.springframework.cloud.openfeign.FeignClientsRegistrar.getName(name);
	}
	...
	private String getContextId(Map<String, Object> attributes) {
		...
		return org.springframework.cloud.openfeign.FeignClientsRegistrar.getName(contextId);
	}
	...
	private String getUrl(Map<String, Object> attributes) {
		...
		return org.springframework.cloud.openfeign.FeignClientsRegistrar.getUrl(url);
	}
	...
	private String getPath(Map<String, Object> attributes) {
		...
		return org.springframework.cloud.openfeign.FeignClientsRegistrar.getPath(path);
	}
	...
	private String getClientName(@Nullable Map<String, Object> client) {
		...
		throw new IllegalStateException(
				"必须在 @" + FeignClient.class.getSimpleName() + " 中提供 'name' 或 'value'");
	}
