...
public class SecurityUtils {
	 ...
	 * @return 用户对象，如果认证主体不是ExtaUser类型则返回null
	 */
	public ExtraUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof ExtraUser) {
			return (ExtraUser) principal;
		}
		return null;
	}
